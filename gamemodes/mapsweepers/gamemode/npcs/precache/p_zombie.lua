...
local precacheModels = {
	"models/headcrab.mdl", --this is the fast headcrab
	"models/headcrabclassic.mdl", --this is the normal one.
	...
	"models/jcms/zombiespawner.mdl"
}

if CLIENT or jcms.HasEpisodes() then
	table.insert(precacheModels, "models/zombie/zombie_soldier.mdl")
end
